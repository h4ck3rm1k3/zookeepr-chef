...
gem 'knife-vagrant2'
gem 'poise-application', :path => 'cookbooks/application'
gem 'poise-application-python', :path => 'cookbooks/application_python'
gem 'poise-application-git', :path => 'cookbooks/application_git'
gem 'pry-rescue'
